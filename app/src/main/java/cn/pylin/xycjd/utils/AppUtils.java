...
public class AppUtils {
     ...
     * @return 应用列表
     */
    public static List<AppInfoManager> getInstalledApps(Context context, boolean includeSystemApps) {
        List<AppInfoManager> appInfoManagerList = new ArrayList<>();
        ...
        try {
            ...
            for (PackageInfo packageInfo : packageInfoList) {
                try {
                    ...
                    appInfoManagerList.add(appInfoManager);
                } catch (Exception e) {
            ...
            // 按应用名称排序
            Collections.sort(appInfoManagerList, new Comparator<AppInfoManager>() {
                @Override
                public int compare(AppInfoManager o1, AppInfoManager o2) {
